...
void loop()
{
  ...
  if (interCount<3) targetRPM[0]=395; 
  else if (interCount>3 & interCount<6) targetRPM[0]=585;
  else if (interCount>6 & interCount<9) targetRPM[0]=775;
  else if (interCount>9 & interCount<12) targetRPM[0]=965;
  else if (interCount>12 & interCount<15) targetRPM[0]=1155;
  else {
    targetRPM[0]=0; // Turn off pump after 3x2 decays
    z1state=0; 
  }
  
  if (interCount<3) targetRPM[3]=395;
  else if (interCount>3 & interCount<6) targetRPM[3]=585;
  else if (interCount>6 & interCount<9) targetRPM[3]=775;
  else if (interCount>9 & interCount<12) targetRPM[3]=965;
  else if (interCount>12 & interCount<15) targetRPM[3]=1155;
  else {
    targetRPM[3]=0;
    z2state=0; 
  }
